...
export const STAGES = [
  ...
  { id: 2, name: "ENTRANCE", rounds: 5, color: "#FF9500", tagline: "Numbers grow, paths deepen" },
  { id: 3, name: "ENTRANCE", rounds: 5, color: "#E85D3F", tagline: "Think sharp and push forward" },
];
